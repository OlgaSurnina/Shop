...
//корзина
let basket = document.querySelector(`.logotip__basket-sku`);//кружок корзины
let basketBtn = document.querySelector(`.box-price__btn-cart`);// кнопка добавить в корзину
